...
<hmtl>
    ...
    <body>
        ...
        <?php 
            ...
            print '<div style = "position:relative;"><img src = "'.$_SESSION["capa"].'" height= "400px" width="100%" style = "filter: blur(4px); left:1px; top:1px; z-index: 1;" />';
            print '<div style = "position:absolute;"><img src = "'.$_SESSION["perfil"].'" height= "250px" width="250px" style = "margin-top: -100%; margin-left: 2%; left:1px; top:1px; z-index: 2;" /></div></div>';
            print '<h5 style = "margin-top: 6%;letter-spacing: 3px; font-family: arial">
