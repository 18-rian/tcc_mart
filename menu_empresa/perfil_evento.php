        ...
        <div  id = "area">
            ...
            <?php
                ...
                if(mysqli_num_rows($query) > 0) //Se verdadeiro
                {
                    ...
                    print '<div class = "table-responsive"><table class="table table-hover">';
                    print '<thead>
                      <tr>
            ...
            <?php 
                print '<a href = "../contratacoes_editais/menu_negociacao.php"><button class="btn btn-dark" style = "margin-left: 2%; margin-top: 10%;">Realizar contratação de artistas para este evento</button></a>';
                print '<button  onclick = "excluir('.$sessao_exclu.');" class="btn btn-dark" style = "margin-left: 2%; margin-top: 10%;">Excluir evento</button>'; 
